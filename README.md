# Responsive Startup Website – React Version

A startup website developed with **React** and **Vite**, focused on reusable components and responsiveness for mobile and desktop.  
The project follows a component-based architecture and dynamic rendering using **props**.
